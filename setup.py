...
for arg in sys.argv:
    ...
    if arg.startswith('--prefix'):
        proteus_install_path = proteus_install_path.partition(sys.prefix + '/')[-1]
        break
PROTEUS_SUPERLU_INCLUDE_DIR='/home/milad/.hashdist/bld/superlu/hauwu7z2bj7e/include'
print 'PROTEUS_SUPERLU_INCLUDE_DIR=',PROTEUS_SUPERLU_INCLUDE_DIR
print 'PROTEUS_SUPERLU_H=',PROTEUS_SUPERLU_H
